...
namespace libtp::tp::d_com_inf_game
{
    ...
    struct GameInfo
    {
        libtp::tp::d_save::SaveInfo save_file; //0 - F38
    ...
    struct dComIfG_play //pulled this from decomp
    {
        ...
        /* 0x03EE8 */ libtp::tp::d_stage::dStage_stageDt mStageData;
        /* 0x03F8C */ libtp::tp::d_stage::dStage_roomControl* mRoomControl;
        /* 0x03F90 */ libtp::tp::d_event::dEvt_control mEvent;
        ...
        /* 0x04E60 */ libtp::tp::c_xyz::cXyz mCameraTarget;
